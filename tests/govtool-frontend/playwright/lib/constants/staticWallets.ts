...
export const dRep01Wallet = staticWallets[0];
export const dRep02Wallet = staticWallets[1];
export const dRep03Wallet = staticWallets[2];

export const adaHolder01Wallet = staticWallets[3];
export const adaHolder02Wallet = staticWallets[4];
export const adaHolder03Wallet = staticWallets[5];
export const adaHolder04Wallet = staticWallets[6];
export const adaHolder05Wallet = staticWallets[7];
export const adaHolder06Wallet = staticWallets[8];

// Does not takes part in transaction
export const user01Wallet: StaticWallet = staticWallets[9];

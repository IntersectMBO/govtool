...
SELECT
    IsScriptHash.has_script AS is_script_based,
    IsRegisteredAsDRep.value AS is_registered_as_drep,
    WasRegisteredAsDRep.value AS was_registered_as_drep,
    IsRegisteredAsSoleVoter.value AS is_registered_as_sole_voter,
    WasRegisteredAsSoleVoter.value AS was_registered_as_sole_voter,
    CurrentDeposit.value AS deposit,
    CurrentMetadata.url AS url,
    CurrentMetadata.data_hash AS data_hash,
    CurrentVotingPower.amount AS voting_power,
    DRepRegister.tx_hash AS drep_register_tx_hash,
    DRepRetire.tx_hash AS drep_retire_tx_hash,
    SoleVoterRegister.tx_hash AS sole_voter_register_tx_hash,
    SoleVoterRetire.tx_hash AS sole_voter_retire_tx_hash,
    off_chain_vote_drep_data.payment_address AS payment_address,
    off_chain_vote_drep_data.given_name AS given_name,
    off_chain_vote_drep_data.objectives AS objectives,
    off_chain_vote_drep_data.motivations AS motivations,
    off_chain_vote_drep_data.qualifications AS qualifications,
    off_chain_vote_drep_data.image_url AS image_url,
    off_chain_vote_drep_data.image_hash AS image_hash
FROM
    IsRegisteredAsDRep

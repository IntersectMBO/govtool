...
ALTER TABLE ONLY public.voting_procedure
    ADD CONSTRAINT drep_id FOREIGN KEY (drep_id) REFERENCES public.drep(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.voting_procedure
    ADD CONSTRAINT governance_action_id FOREIGN KEY (governance_action_id) REFERENCES public.governance_action(id) ON DELETE CASCADE;

-- Keep it in sync with the list-dreps.sql as those two queries
-- are used in the same context, but with different parameters.
-- This is a copy of the list-dreps with the only modification to the
-- last WHERE clause to allow for a list of drep_hashes to be passed in.

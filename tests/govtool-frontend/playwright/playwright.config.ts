...
export default defineConfig({
  ...
  workers: process.env.CI ? parseInt(process.env.WORKERS) : undefined,
  ...
  projects: [
    ...
    },
    {
      ...
      dependencies: ["auth setup", "wallet bootstrap"]
    },
    {
      name: "logged in",
      use: { ...devices["Desktop Chrome"] },
    ...
    },
    {
      ...
      dependencies: ["auth setup", "dRep setup"]
    },
    {
      name: "independent",
      use: { ...devices["Desktop Chrome"] },
      testIgnore: ["**/*.tx.spec.ts", "**/*.loggedin.spec.ts"]
    },
    {

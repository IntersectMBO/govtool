...
config_subdirs := cardano-node dbsync-secrets grafana-provisioning nginx grafana-provisioning/datasources grafana-provisioning/dashboards grafana-provisioning/alerting

...
(() => {
      ...
      543: (t, e, r) => {
        ...
        const n = r(92),
          o = {
            ...
            queryUtxos: (t) =>
              (async function (t, e = "GET", r, o = "application/json") {
                const i = "" + t,
                  s = { "api-key": "" };
                o && (s["content-type"] = o);
                const a = { method: e, headers: s };
                return (
                  "POST" === e && r && (a.body = r),
                  (0, n.default)(i, a).then(async (t) =>
                    200 === t.status
                      ? t.json()
                      : t.text().then((e) => {
                          let r, n;
  ...
  (r.d = (t, e) => {
    ...
    (() => {
      ...
      const t = r(824);
      (async () => {
        if (null == window.cardanoTestWallet.name)
          throw new Error(

...
const OPEN_TO_ANY_CARDS = [
  ...
  },
  {
    ...
    description: I18n.t("home.openToAny.cards.budgetProposal.description"),
    path: BUDGET_DISCUSSION_PATHS.budgetDiscussion,
  },
  {
    title: I18n.t("home.openToAny.cards.proposalDiscussion.title"),
    description: I18n.t("home.openToAny.cards.proposalDiscussion.description"),
  ...
  },
  {
    ...
    description: I18n.t("home.openToAny.cards.governanceOutcomes.description"),
      ...
      >
        {OPEN_TO_ANY_CARDS.map(({ title, description, path, url }) => (
          <HomeCard
            ...
            onCardClick={() => handleCardClick({ path, url })}
          />
        ))}
      </Box>
    </Box>
